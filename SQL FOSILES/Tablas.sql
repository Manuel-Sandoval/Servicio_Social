...
CREATE TABLE FOSILES.FOSILES (
    ...
    CONSTRAINT FOSI_ESTA_FK FOREIGN KEY (ID_ESTADO, ID_PAIS) REFERENCES FOSILES.ESTADOS (ID_ESTADO, ID_PAIS),
    CONSTRAINT FOSI_MUNI_FK FOREIGN KEY (ID_MUNICIPIO, ID_ESTADO, ID_PAIS) REFERENCES FOSILES.MUNICIPIOS (ID_MUNICIPIO, ID_ESTADO, ID_PAIS),
